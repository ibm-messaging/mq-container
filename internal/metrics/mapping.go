...
func generateMetricNamesMap() map[string]metricLookup {
	...
	metricNamesMap := map[string]metricLookup{
		...
		"DISK/Log/Log - timestamp of slowest write":                               metricLookup{"log_slowest_write_timestamp_seconds", true},
		...
		"NHAREPLICA/REPLICATION/Backlog long-term average bytes":                  metricLookup{"replication_backlog_long_term_average_bytes", true},
		"NHAREPLICA/REPLICATION/Catch-up time percentage":                         metricLookup{"replication_catch_up_time_percentage", true},
		"NHAREPLICA/REPLICATION/Throttling time percentage":                       metricLookup{"replication_throttling_time_percentage", true},
		"NHAREPLICA/REPLICATION/Log - write latency":                              metricLookup{"replication_log_write_latency_seconds", true},
		"NHAREPLICA/REPLICATION/Log - write size":                                 metricLookup{"replication_log_write_size_bytes", true},
		"NHAREPLICA/REPLICATION/Log - slowest write since restart":                metricLookup{"replication_log_slowest_write_since_restart_seconds", true},
		"NHAREPLICA/REPLICATION/Log - timestamp of slowest write":                 metricLookup{"replication_log_slowest_write_timestamp_seconds", true},

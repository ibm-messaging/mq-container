...
yq write -i $IMAGE_MANIFEST_FILE metadata.commitId $COMMITID
yq write -i $IMAGE_MANIFEST_FILE metadata.travisBuildId $PIPELINE_RUN_ID
yq write -i $IMAGE_MANIFEST_FILE metadata.travisBuildUrl $BUILDURL

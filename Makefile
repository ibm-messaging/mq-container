...
###############################################################################
# Push/pull targets
#$(COMMAND) login "https://docker-na.artifactory.swg-devops.com" -u $(MQ_DELIVERY_REGISTRY_USER) -p $(MQ_DELIVERY_REGISTRY_CREDENTIAL)
###############################################################################

...
var mHeur = map[string]string{
	...
	// These were added to STATQ during the 9.4 lifetime and backported to some older releases.
	// The open input/output counts need to be mapped to the metric names used from the QSTATUS
	// responses for backwards compatibility.
	// The other handle counts ought to follow the same naming convention.
	//
	// "Publish count" is the number of queue handles held by the queue manager to write publications.
	// Note that "output count" includes both the "browse count" and "publish count". Though we only
	// extract the input/output published metrics if we are not already getting them from QSTATUS
	"open_input_count":   "input_handles",
	"open_output_count":  "output_handles",
	"open_browse_count":  "browse_handles",
	"open_publish_count": "publish_handles",

	// STATQ - "Extended" values. Not reported by default as they are primarily for L2/L3 support.
	// Have to opt-in via the SubscriptionSelector configuration option.
	"log_-_slowest_write_since_restart": "log_slowest_write_since_restart",
	"log_-_timestamp_of_slowest_write":  "log_timestamp_of_slowest_write",
	"msg_search_count":                  "msg_search",
	"msg_not_found_count":               "msg_not_found",
	"msg_examine_count":                 "msg_examine",
	"intran_get_skipped_count":          "intran_get_skipped",
	"intran_put_skipped_count":          "intran_put_skipped",
	"selection_mismatch_count":          "selection_mismatch",
	"correlid_mismatch_short_count":     "correlid_mismatch_short",
	"correlid_mismatch_long_count":      "correlid_mismatch_long",
	"msgid_mismatch_count":              "msgid_mismatch",
	"load_msg_dtl_count":                "load_msg_dtl",

	// Class: Native HA
	"acknowledged_log_sequence_number":                "acknowledged_log_sequence_number",
	"average_network_round_trip_time":                 "average_network_round_trip_time",
	"backlog_average_bytes":                           "backlog_average_bytes",
	"backlog_bytes":                                   "backlog_bytes",
	"catch-up_compressed_log_bytes_sent":              "catch_up_compressed_log_sent_bytes",
	"catch-up_log_bytes_decompressed":                 "catch_up_log_decompressed_bytes",
	"catch-up_log_bytes_sent":                         "catch_up_log_sent_bytes",
	"catch-up_log_data_average_compression_time":      "catch_up_log_data_average_compression_time_bytes",
	"catch-up_log_data_average_decompression_time":    "catch_up_log_data_average_decompression_time_bytes",
	"catch-up_uncompressed_log_bytes_sent":            "catch_up_uncompressed_log_sent_bytes",
	"compressed_log_bytes_sent":                       "compressed_log_sent_bytes",
	"log_-_disk_written_log_sequence_number":          "log_disk_written_log_sequence_number",
	"log_-_quorum_log_sequence_number":                "log_quorum_log_sequence_number",
	"log_bytes_decompressed":                          "log_decompressed_bytes",
	"log_bytes_sent":                                  "log_sent_bytes",
	"log_data_average_compression_time":               "log_data_average_compression_time_bytes",
	"log_data_average_decompression_time":             "log_data_average_decompression_time_bytes",
	"log_file_system_-_free_space":                    "log_file_system_free_space_bytes",
	...
	"rebase_count":                                    "rebase",
	"recovery_log_sequence_number":                    "recovery_log_sequence_number",
	"synchronous_compressed_log_bytes_sent":           "synchronous_compressed_log_sent_bytes",
	"synchronous_log_bytes_decompressed":              "synchronous_log_decompressed_bytes",
...
// to a format preferred by the backend (eg OpenTelemetBytesry).
func formatDescription(elem *MonElement) string {
	...
	// Force the newer NHA metrics to include an indicator as the descriptions
	// duplicate some of the older NHA REPLICA names, so we would end up with
	// metrics getting confused (or causing errors when reported)

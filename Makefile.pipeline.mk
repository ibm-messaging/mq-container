...
ifeq "$(FEATURE_BUILD_OVERRIDE)" "true"
	IMAGE_REGISTRY_DELIVERY_NAMESPACE=$(IMAGE_REGISTRY_DELIVERY_NAMESPACE_OVERRIDE)
...
ifneq "$(LTS_TAG_OVERRIDE)" "$(EMPTY)"
	...
	IMAGE_REGISTRY_DELIVERY_NAMESPACE:=$(IMAGE_REGISTRY_DELIVERY_NAMESPACE)$(LTS_TAG)
endif

ifneq "$(IMAGE_REGISTRY_DELIVERY_NAMESPACE)" "$(EMPTY)"
	IMAGE_REGISTRY_DELIVERY_FULL_PATH=$(IMAGE_REGISTRY_DELIVERY_HOSTNAME)/$(IMAGE_REGISTRY_DELIVERY_NAMESPACE)/$(IMAGE_REGISTRY_DELIVERY_REPO_PREFIX)
else
	IMAGE_REGISTRY_DELIVERY_FULL_PATH=$(IMAGE_REGISTRY_DELIVERY_HOSTNAME)
endif
...
MQ_IMAGE_DEVSERVER_AMD64=$(IMAGE_REGISTRY_DELIVERY_FULL_PATH)/$(MQ_IMAGE_DEVSERVER):$(MQ_AMD64_TAG)
MQ_IMAGE_DEVSERVER_S390X=$(IMAGE_REGISTRY_DELIVERY_FULL_PATH)/$(MQ_IMAGE_DEVSERVER):$(MQ_S390X_TAG)
MQ_IMAGE_DEVSERVER_PPC64LE=$(IMAGE_REGISTRY_DELIVERY_FULL_PATH)/$(MQ_IMAGE_DEVSERVER):$(MQ_PPC64LE_TAG)
MQ_IMAGE_ADVANCEDSERVER_AMD64=$(IMAGE_REGISTRY_DELIVERY_FULL_PATH)/$(MQ_IMAGE_ADVANCEDSERVER):$(MQ_AMD64_TAG)
MQ_IMAGE_ADVANCEDSERVER_S390X=$(IMAGE_REGISTRY_DELIVERY_FULL_PATH)/$(MQ_IMAGE_ADVANCEDSERVER):$(MQ_S390X_TAG)
MQ_IMAGE_ADVANCEDSERVER_PPC64LE=$(IMAGE_REGISTRY_DELIVERY_FULL_PATH)/$(MQ_IMAGE_ADVANCEDSERVER):$(MQ_PPC64LE_TAG)

MQ_IMAGE_DEVSERVER_MANIFEST_IFIX=$(IMAGE_REGISTRY_DELIVERY_FULL_PATH)/$(MQ_IMAGE_DEVSERVER):$(MQ_MANIFEST_TAG)
MQ_IMAGE_ADVANCESERVER_MANIFEST_IFIX=$(IMAGE_REGISTRY_DELIVERY_FULL_PATH)/$(MQ_IMAGE_ADVANCEDSERVER):$(MQ_MANIFEST_TAG)

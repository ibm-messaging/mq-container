...
# sps:This flag indicates a branch commit behaving as a merge build commit
ifeq "$(FEATURE_BUILD_OVERRIDE)" "true"
	MQ_DELIVERY_REGISTRY_NAMESPACE=$(DELIVERY_REGISTRY_NAMESPACE_OVERRIDE)

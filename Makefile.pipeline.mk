...
ifeq "$(FEATURE_BUILD_OVERRIDE)" "true"
	IMAGE_REGISTRY_DELIVERY_NAMESPACE:=$(IMAGE_REGISTRY_DELIVERY_NAMESPACE_OVERRIDE)/$(IMAGE_REGISTRY_DELIVERY_REPO_PREFIX_OVERRIDE)
...
ifneq "$(IMAGE_REGISTRY_DELIVERY_NAMESPACE)" "$(EMPTY)"
	IMAGE_REGISTRY_DELIVERY_FULL_PATH=$(IMAGE_REGISTRY_DELIVERY_HOSTNAME)/$(IMAGE_REGISTRY_DELIVERY_NAMESPACE)
else
